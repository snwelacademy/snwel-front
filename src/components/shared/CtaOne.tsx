...
const CtaOne = () => {
  return (
    <div className='py-36 px-4 relative z-20' style={{backgroundImage: 'url(src/assets/collection-of-multiethnic-business-people-portraits-collage-gray-backgrounds-square.jpg)', backgroundRepeat: 'repeat-x', backgroundPosition: 'center', backgroundSize: 'contain'}}>
